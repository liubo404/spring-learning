...
public final class PropertiesFactoryBeanTests {
	...
	private static final Resource TEST_PROPS = null;// qualifiedResource(CLASS, "test.properties");
	private static final Resource TEST_PROPS_XML =null;// qualifiedResource(CLASS, "test.properties.xml");
